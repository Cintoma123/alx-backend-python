...
SECRET_KEY = 'django-insecure-4#t*#kf^+n_*i#!)7ge_jn+^#uwz9_hc5jos8nn(2%$)abv5p7'
...
LOGGING = {
    ...
    'handlers': {
        'custom_handler': {
            ...
            'filename': 'requests.log',  # Log file to store request logs
        },
    },
    'loggers': {
        'requests_log': {
...
MIDDLEWARE = [
    ...
    'chats.OffensiveLanguageFilterMiddleware:'
    'chats.RolepermissionMiddleware'
]
